...
class ActionConsumeItemTest {
    ...
    @Test
    void perform() {
        new ActionConsumeItem().perform(gameState, new Object[]{SpaceItem.CHICKEN}, CrewType.HUMAN.getInstance("test"));
        assertEquals(new HashMap<SpaceItem, Integer>() {{
                         put(SpaceItem.PORK, 1);
                     }},
